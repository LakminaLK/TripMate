        ...
        <div x-data="{ open: false }" class="relative">
            ...
            <div x-show="open" 
                ...
                <div class="px-4 py-3 border-b border-gray-100">
                    ...
                    <p class="text-xs text-gray-500">You have 5 new notifications</p>
                </div>
                ...
                <div class="max-h-96 overflow-y-auto">
                    ...
                    <div class="px-4 py-3 hover:bg-gray-50 transition-colors border-b border-gray-50">
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xs text-gray-600">Jane Smith registered as a new customer</p>
                    ...
                    <div class="px-4 py-3 hover:bg-gray-50 transition-colors border-b border-gray-50">
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xs text-gray-600">Booking #BK0013 at The Tea Cottage Resort</p>
                    ...
                    <div class="px-4 py-3 hover:bg-gray-50 transition-colors border-b border-gray-50">
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-sm font-medium text-gray-900">New Hotel Registration</p>
                                <p class="text-xs text-gray-600">Sunset Resort registered for approval</p>
                    ...
                    <div class="px-4 py-3 hover:bg-gray-50 transition-colors border-b border-gray-50">
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xs text-gray-600">$10.00 commission from booking #BK0012</p>
                    ...
                    <div class="px-4 py-3 hover:bg-gray-50 transition-colors">
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xs text-gray-600">Scheduled maintenance tonight at 2 AM</p>
