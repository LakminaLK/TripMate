...
@section('content')
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-xl shadow-md border border-gray-200 mb-6">
        <div>
            ...
            <p class="text-gray-600">Manage your admin account settings and security</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="bg-white p-6 rounded-xl shadow-md border border-gray-200">
            <div class="mb-6">
                ...
                <p class="text-sm text-gray-600 mt-1">Change your login username for this admin account</p>
            </div>
            
            <form action="{{ route('admin.profile.username.update') }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-blue-700 mt-1">Username must be unique among admins and case-sensitive. You'll need to use the new username for future logins.</p>
                        </div>
                    </div>
                </div>
        ...
        <!-- Right Side - Password Update Section -->
            <div class="bg-white p-6 rounded-xl shadow-md border border-gray-200">
                <div class="mb-6">
                    <h3 class="text-lg font-semibold text-gray-900 flex items-center">
                        <svg class="w-5 h-5 mr-2 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <p class="text-sm text-gray-600 mt-1">Ensure your admin account stays secure with a strong password</p>
                </div>
                
                <form action="{{ route('admin.profile.password.update') }}" method="POST" class="space-y-6" autocomplete="on">
                    @csrf
                    @method('PUT')
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input
                                    ...
                                    class="w-full px-4 py-3 pr-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 outline-none focus:outline-none"
                                    required
                    ...
                    <div class="bg-amber-50 border border-amber-200 rounded-lg p-4">
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-amber-700 mt-1">Password must be at least 8 characters long for security.</p>
                            </div>
                        </div>
                    </div>
