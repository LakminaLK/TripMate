<!-- Mobile Sidebar -->
<div id="mobileSidebar" class="fixed inset-0 bg-gray-800 bg-opacity-50 dark:bg-gray-900 dark:bg-opacity-70 z-40 hidden md:hidden transition-colors duration-300" onclick="toggleSidebar()">
    <div class="w-64 bg-white dark:bg-dark-100 h-full p-6 space-y-2 text-sm font-medium pt-24 shadow-xl transition-colors duration-300" onclick="event.stopPropagation()">
        @php
            $menuItems = [
                [
                ...
                [
                    'route' => 'hotel.profile.edit',
                    'routePattern' => 'hotel.profile.*',
                    'label' => 'Profile',
