...
@section('content')
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-xl shadow-md border border-gray-200 mb-6">
        <div>
            <h1 class="text-3xl font-bold text-gray-800">Hotel Management</h1>
            <p class="text-gray-600">Manage your hotel details, images, facilities, and status</p>
        </div>
                    ...
                    @else
                        <div class="h-48 bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center">
                            <div class="text-center text-gray-500">
                                ...
                                <h2 class="text-xl font-bold text-gray-700">{{ $hotel->name }}</h2>
                    ...
                    <div class="space-y-4">
                        <div class="border-b border-gray-100 pb-3">
                            ...
                            <div class="space-y-2">
                                ...
                                @if($hotel->website)
                                <div class="flex items-center text-gray-700">
                                    <i class="fas fa-globe w-4 text-gray-400 mr-3"></i>
                        ...
                        <div class="border-b border-gray-100 pb-3">
                            <h3 class="text-sm font-semibold text-gray-500 uppercase tracking-wide mb-2">Location</h3>
                            <div class="flex items-start text-gray-700">
                                ...
                                <div>
                                    ...
                                    @if($hotel->address)
                                        <p class="text-xs text-gray-500 mt-1">{{ $hotel->address }}</p>
                                    @endif
                                    @if($hotel->map_url)
                                        <a href="{{ $hotel->map_url }}" target="_blank" class="text-sm text-blue-600 hover:underline">
                                            View on Google Maps
                                        </a>
                                    @elseif($hotel->latitude && $hotel->longitude)
                                        <a href="https://www.google.com/maps/search/?api=1&query={{ $hotel->latitude }},{{ $hotel->longitude }}" target="_blank" class="text-sm text-blue-600 hover:underline">
                                            View on Google Maps
                                        </a>
                                    @endif
                                </div>
                        ...
                        <div>
                            <h3 class="text-sm font-semibold text-gray-500 uppercase tracking-wide mb-2">Rating</h3>
                            <div class="flex items-center">
                                ...
                                <span class="text-sm text-gray-600">{{ $hotel->star_rating }}/5 Stars</span>
                            </div>
                        </div>
                        @endif
                    </div>
                ...
                <div class="p-6">
                    ...
                    @else
                        <div class="text-center py-8 text-gray-500">
                            ...
                            <p class="text-gray-600">No description added yet</p>
                            <p class="text-sm text-gray-500 mt-1">Add a compelling description to attract more guests</p>
                        </div>
                    @endif
                </div>
            </div>
                ...
                <div class="p-6">
                    @if($hotel->facilities->count() > 0)
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            @foreach($facilitiesByCategory as $category => $facilities)
                                <div>
                                    <h4 class="text-sm font-semibold text-gray-700 mb-3 capitalize border-b border-gray-100 pb-2">
                                        {{ str_replace('_', ' ', $category) }}
                                    </h4>
                                    <div class="space-y-2">
                                        @foreach($facilities as $facility)
                                            <div class="flex items-center text-gray-700">
                                                <i class="{{ $facility->icon ?? 'fas fa-check' }} text-green-600 w-4 mr-3"></i>
                    ...
                    @else
                        <div class="text-center py-8 text-gray-500">
                            ...
                            <p class="text-gray-600">No facilities selected yet</p>
                            <p class="text-sm text-gray-500 mt-1">Add facilities to showcase your hotel amenities</p>
                        </div>
                    @endif
                </div>
            </div>
                ...
                <div class="p-6">
                    ...
                    @else
                        <div class="text-center py-8 text-gray-500">
                            ...
                            <p class="text-gray-600">No additional images uploaded</p>
                            <p class="text-sm text-gray-500 mt-1">Upload images to showcase your hotel</p>
                        </div>
                    @endif
                </div>
            </div>
