...
<!-- ✅ Professional Navbar -->
<header x-data="{ isOpen: false, scrolled: false }" x-cloak
        @scroll.window="scrolled = window.pageYOffset > 50"
        :class="scrolled ? 'bg-white/95 backdrop-blur-md shadow-lg' : '{{ $transparent ?? false ? 'bg-transparent' : 'bg-white/95 backdrop-blur-md shadow-lg' }}'"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center py-4">
            ...
            <a href="{{ route('landing') }}" class="flex items-center space-x-3 group">
                ...
                <div>
                    <h1 :class="scrolled ? 'text-gray-900' : '{{ $transparent ?? false ? 'text-white' : 'text-gray-900' }}'" 
                        class="text-xl font-bold transition-colors">
                        Trip<span class="text-blue-600">Mate</span>
                    </h1>
                    <p :class="scrolled ? 'text-gray-500' : '{{ $transparent ?? false ? 'text-white/70' : 'text-gray-500' }}'" 
